...
// import components
import jalaliday from "../plugin/plugin";
import { default as faLocale } from "../plugin/locale";

// import interfaces
import { GenerateConfig, IlocaleMapObject } from "../interfaces";

// extend dayjs by plugins
